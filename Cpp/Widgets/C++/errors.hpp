...
#define line_number __LINE__
	...
	void printArguments(Colors color, std::string arg, T in, size_t line){
		...
		std::cout << Color(Colors::NORMAL, color) << "# ";
		std::cout << Color(Colors::BOLD, color) << arg;
		std::cout << Color(Colors::NORMAL, color) << ": ";
		std::cout << Color(Colors::BOLD, color) << in;
		std::cout << Color(Colors::NORMAL, color) << " on line ";
		std::cout << Color(Colors::BOLD, color) << line << std::endl;
		std::cout << Color(Colors::NORMAL, color) << "\t";
	}
