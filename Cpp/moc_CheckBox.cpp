...
QT_MOC_LITERAL(5, 41, 5), // "table"
QT_MOC_LITERAL(6, 47, 6), // "size_t"
QT_MOC_LITERAL(7, 54, 5), // "index"
QT_MOC_LITERAL(8, 60, 12) // "changeActive"

    },
    "CheckBox\0stateChanged\0\0state\0std::string\0"
    "table\0size_t\0index\0changeActive"
};
...
void CheckBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stateChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< std::string(*)>(_a[2])),(*reinterpret_cast< size_t(*)>(_a[3]))); break;
        case 1: _t->changeActive((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CheckBox::*_t)(int , std::string , size_t );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CheckBox::stateChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void CheckBox::stateChanged(int _t1, std::string _t2, size_t _t3)
{
