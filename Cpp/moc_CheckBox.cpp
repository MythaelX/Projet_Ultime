...
QT_MOC_LITERAL(7, 53, 12) // "changeActive"

    },
    "CheckBox\0stateChanged\0\0state\0std::string\0"
    "table\0index\0changeActive"
};
...
void CheckBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stateChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< std::string(*)>(_a[2])),(*reinterpret_cast< std::string(*)>(_a[3]))); break;
        ...
        {
            typedef void (CheckBox::*_t)(int , std::string , std::string );
...
// SIGNAL 0
void CheckBox::stateChanged(int _t1, std::string _t2, std::string _t3)
{
