...
QT_MOC_LITERAL(5, 38, 6), // "size_t"
QT_MOC_LITERAL(6, 45, 5), // "index"
QT_MOC_LITERAL(7, 51, 5) // "click"

    },
    "PushButton\0clicked\0\0std::string\0table\0"
    "size_t\0index\0click"
};
...
void PushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< std::string(*)>(_a[1])),(*reinterpret_cast< size_t(*)>(_a[2]))); break;
        ...
        {
            typedef void (PushButton::*_t)(std::string , size_t );
...
// SIGNAL 0
void PushButton::clicked(std::string _t1, size_t _t2)
{
