...
QT_MOC_LITERAL(6, 59, 17) // "TitleBarShowState"
    ...
    "WindowResizeChanged\0state\0TitleBarShowState"
};
...
void Window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Window::WindowTitleChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (Window::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Window::WindowResizeChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (Window::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Window::TitleBarShowState)) {
                *result = 2;
            }
        }
    }
