...
var searchBox = new SearchBox("searchBox", "search",false,'Search');
  ...
  <div id="navrow4" class="tabs3">
    <ul class="tablist">
      ...
      <li class="current"><a href="globals_func_a.php#index_a"><span>a</span></a></li>
...
<script type="text/javascript">
$(document).ready(function(){initNavTree('globals_func_a.php','');});
</script>
<div id="doc-content">
...
<li>ajaxRequest()
: <a class="el" href="d1/d84/a00052.php#a20cd18a74fb2bbedbfacdb71b9aeadb7">palmares.js</a>
