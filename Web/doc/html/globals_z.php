...
var searchBox = new SearchBox("searchBox", "search",false,'Search');
  ...
  <div id="navrow4" class="tabs3">
    <ul class="tablist">
      ...
      <li class="current"><a href="globals_z.php#index_z"><span>z</span></a></li>
    </ul>
  </div>
</div><!-- top -->
...
<script type="text/javascript">
$(document).ready(function(){initNavTree('globals_z.php','');});
</script>
<div id="doc-content">
...
<li>Z
: <a class="el" href="d1/d2b/a00018.php#a0e13cb15ff3d6fbe4b9cd26ef446070e">bootstrap.bundle.min.js</a>
</li>
</ul>
</div><!-- contents -->
</div><!-- doc-content -->
