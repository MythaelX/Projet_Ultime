...
/*! \brief	Initialize all the galleries */
...
/*!
* \brief	Create a gallery
*		\param[in]		g				The gallery object
*/
function createGallery(g){
	/* Initialization of the extern gallery */
		GALLERY = g;
...
/*!
* \brief	Create the gallery arrow
*		\param[in]		parent			The parent object of the arrow
*		\param[in]		arrow			The arrow object
*/
...
/*!
* \brief	Show the arrows on hover
*		\param[in]		el				The parent of the arrows
*/
...
/*!
* \brief	The movement of the gallery
*		\param[in]		el				The content of the gallery
*/
